...
namespace MoveMentor.Controllers
{
    ...
    public class TreningsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            // var context = _context.Trening.Where(s => s.UserId == _userManager.GetUserId(User));
            //return View(await context.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DateTimeStart,DateTimeEnd,SportTypeId,UserId")] Trening trening)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DateTimeStart,DateTimeEnd,SportTypeId,UserId")] Trening trening)
        {
            if (id != trening.Id)
            {
                return NotFound();
